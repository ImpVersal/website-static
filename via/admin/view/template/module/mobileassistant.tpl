            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form_mobassist" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="entry_disable_mis_ord_notif"><?php echo $entry_disable_mis_ord_notif; ?></label>
                            <div class="col-sm-10">
                                <input type="checkbox" id="mobassist_disable_mis_ord_notif" class="form-control" name="mobassist_disable_mis_ord_notif" value="1" <?php echo ($settings['mobassist_disable_mis_ord_notif'] == 1 ? 'checked="true"' : ""); ?> />
                            </div>
                        </div>
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form_mobassist">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" id="mobassist_disable_mis_ord_notif" name="mobassist_disable_mis_ord_notif" value="1" <?php echo ($settings['mobassist_disable_mis_ord_notif'] == 1 ? 'checked="true"' : ""); ?> /></td>
                        </tr>
...
<script type="text/javascript"><!--
    $(document).ready(function() {
        ...
        qrcode.makeCode('<?php echo $qrcode_settings ?>');
